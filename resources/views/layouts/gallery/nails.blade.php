        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item position-relative active" style="min-height: 100vh;">
                    <img  style="width:20em;" class="position-absolute w-100 h-100" src='{{ asset('img/n1.PNG') }}' style="object-fit: cover;">
                ...
                <div class="carousel-item position-relative" style="min-height: 100vh;">
                    <img  style="width:20em;" class="position-absolute w-100 h-100" src='{{ asset('img/n2.PNG') }}' style="object-fit: cover;">
                    {{-- <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="text-white text-uppercase mb-3 animate__animated animate__fadeInDown" style="letter-spacing: 3px;">Spa & Beauty Center</h6>
                ...
                <div class="carousel-item position-relative" style="min-height: 100vh;">
                    <img style="width:20em;" class="position-absolute w-100 h-100" src='{{ asset('img/n3.PNG') }}' style="object-fit: cover;">
                    {{-- <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="text-white text-uppercase mb-3 animate__animated animate__fadeInDown" style="letter-spacing: 3px;">Spa & Beauty Center</h6>
                ...
                <div class="carousel-item position-relative" style="min-height: 100vh;">
                    <img style="width:20em;" class="position-absolute w-100 h-100" src='{{ asset('img/n4.PNG') }}' style="object-fit: cover;">
                    {{-- <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="text-white text-uppercase mb-3 animate__animated animate__fadeInDown" style="letter-spacing: 3px;">Spa & Beauty Center</h6>
                            <h3 class="display-3 text-capitalize text-white mb-3">collection of trend-led hairstyles</h3>
                ...
                <div class="carousel-item position-relative" style="min-height: 100vh;">
                    <img style="width:20em;" class="position-absolute w-100 h-100" src='{{ asset('img/n5.PNG') }}' style="object-fit: cover;">
                    {{-- <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="text-white text-uppercase mb-3 animate__animated animate__fadeInDown" style="letter-spacing: 3px;">Spa & Beauty Center</h6>
                            <h3 class="display-3 text-capitalize text-white mb-3">collection of trend-led hairstyles</h3>
